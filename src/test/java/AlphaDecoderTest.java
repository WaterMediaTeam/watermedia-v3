...
import org.watermedia.api.decode.formats.webp.AlphaDecoder;
...
public class AlphaDecoderTest {
     ...
     */
    private void testUncompressedNoFilter() throws DecoderException {
        final int width = 4;
        final int height = 4;
     ...
     */
    private void testUncompressedHorizontalFilter() throws DecoderException {
        final int width = 4;
        final int height = 2;
     ...
     */
    private void testUncompressedVerticalFilter() throws DecoderException {
        final int width = 2;
        final int height = 4;
     ...
     */
    private void testUncompressedGradientFilter() throws DecoderException {
        final int width = 2;
        final int height = 2;
    ...
    void testTruncatedData() {
        ...
        assertThrows(DecoderException.class, () -> AlphaDecoder.decode(buffer, width, height),
    ...
    void testEmptyBuffer() {
        ...
        // SHOULD THROW EXCEPTION
        assertThrows(DecoderException.class, () -> AlphaDecoder.decode(buffer, 4, 4),
