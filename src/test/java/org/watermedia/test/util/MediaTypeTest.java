...
public class MediaTypeTest {
    ...
    @Nested
    @DisplayName("ofExtension(path)")
    class OfExtensionTests {
        ...
        @Test
        @DisplayName("no/unknown extension -> UNKNOWN")
