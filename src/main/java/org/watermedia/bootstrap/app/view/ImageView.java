...
/**
 * Displays a GPU texture (banner, icon, thumbnail, video frame), like Android's {@code ImageView}. It
 ...
 */
public final class ImageView extends View<ImageView> {
    ...
    public ImageView image(final int id, final int sourceWidth, final int sourceHeight) {
        this.textureId = id;
    ...
    public ImageView fit(final Fit value) {
        this.fit = value == null ? Fit.CONTAIN : value;
        return this;
    }

    public ImageView tint(final Color value) {
        this.tint = value;
        return this;
    }
