...
import static org.watermedia.api.decode.formats.webp.lossy.VP8Tables.*;
...
public final class VP8LossyDecoder {
    ...
    public static int[] decode(final ByteBuffer data, final int expW, final int expH) throws DecoderException {
        ...
        if (!frm.keyFrame) throw new DecoderException("Only VP8 key frames supported");
    ...
    public static ByteBuffer decodeToBgra(final ByteBuffer data, final int expW, final int expH) throws DecoderException {
        final ByteBuffer buf = data.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    private static State parseCompressedHeader(final VP8BoolDecoder br, final FrameInfo frm) throws DecoderException {
    ...
    private static int decodeTokenVal(final VP8BoolDecoder br, final int[] p) throws DecoderException {
    ...
    private static int readExtra(final VP8BoolDecoder br, final int[] probs) throws DecoderException {
        int v = 0;
    ...
    private static SubMode readSubMode(final VP8BoolDecoder br, final SubMode above, final SubMode left) throws DecoderException {
